...
if __name__ == '__main__':
    ...
    benchmark = 'cceval'
    f_paths = [
                #   f'/data/dengle/projcoder_v1/predictions/{benchmark}/rg_{lang}.jsonl',
                #   f'/data/dengle/projcoder_v1/predictions/{benchmark}/rc_{lang}.jsonl',
                #   f'/data/dengle/projcoder_v1/predictions/{benchmark}/ours_{lang}.jsonl',
                ...
                #   f'/data/dengle/projcoder_v1/predictions/{benchmark}/repofuse_{lang}.jsonl'
                ]
    for file in f_paths:
        ...
        print(format(em_sum/len(examples) * 100, '.2f'), '&', format(f1_sum/len(examples) * 100, '.2f'))
        # print()