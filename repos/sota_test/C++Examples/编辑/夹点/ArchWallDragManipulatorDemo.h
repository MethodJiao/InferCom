 ...
 *  @note:  -
 */
class ArchWallDragManipulatorDemo : public BPPointDragManipulator
{
	DefineSuper(BPPointDragManipulator)
public:
	static ArchWallDragManipulatorDemo* Create();
protected:
	ArchWallDragManipulatorDemo();
	~ArchWallDragManipulatorDemo();
...
private:
	...
	BPGraphicsPtr createDimensionLinear(DemoObject::ModeArchWallDemoP cube, BPProjectR project, BPViewportP viewport);
};

class ArchWallDragManipulatorDemoExtension : public ::BIMBase::Data::IBPDragManipulatorExtension
{
protected:
